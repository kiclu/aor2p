...
void simd_div_8bpc(uint8_t* ptr_r, uint8_t* ptr_g, uint8_t* ptr_b, uint8_t c){
    for(uint32_t k = 0; k < 32; k += 8){
        ...
        __m256i vres_r = _mm256_cvtps_epi32(_mm256_div_ps(fva_r, _mm256_set1_ps(c)));
        ...
        __m256i vres_g = _mm256_cvtps_epi32(_mm256_div_ps(fva_g, _mm256_set1_ps(c)));
        ...
        __m256i vres_b = _mm256_cvtps_epi32(_mm256_div_ps(fva_b, _mm256_set1_ps(c)));
