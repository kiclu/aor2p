...
inline void simd_neg_bmp_8bpc(uint8_t* ptr_r, uint8_t* ptr_g, uint8_t* ptr_b){
...
// no simd, negative, .bmp, 8 bits per channel, no pipeline
inline void neg_bmp_8bpc_npl(imgfile_t* imgfile){
    subi_bmp_8bpc_npl(imgfile, 0xFF);
}
